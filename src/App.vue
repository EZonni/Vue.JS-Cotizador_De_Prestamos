...
<template>
  <div class="my-5 max-w-lg mx-auto bg-white shadow p-10">
    ...
    <div v-if="total > 0" class="my-5 space-y-3 bg-gray-50 p-5">
      ...
      <p class="text-xl text-gray-500 text-center font-bold">Pagos mensuales: {{formatearDinero(pagoMensual)}}</p>

    </div>

    <p v-else class="text-center">Selecciona una cantidad y un plazo</p>
  </div>
